...
LE0FC:
        ...
        ldy     $4000                           ; E11F AC 00 40
        beq     LE0FC                           ; E122 F0 D8
LE124:
        jsr     LE4A6                           ; E124 20 A6 E4
...
LE2DA:
        ...
        .byte   $00,$00,$0C,$0A,$04,$94,$8A,$1F ; E349 00 00 0C 0A 04 94 8A 1F
        .byte   "BL"                            ; E351 42 4C
        .byte   $00                             ; E353 00
LE354:
...
LE8D8:
        ...
        sta     L9CC0,y                         ; E8DA 99 C0 9C
        iny                                     ; E8DD C8
        cpy     L9CC0                           ; E8DE CC C0 9C
...
LEBDD:
        ...
        ldy     #$08                            ; EBE5 A0 08
LEBE7:
        ldx     L9CC0,y                         ; EBE7 BE C0 9C
        lda     L9CC0+1,y                       ; EBEA B9 C1 9C
...
LECCC:
        ...
        sta     $FF                             ; ECD1 85 FF
        ldy     #$90                            ; ECD3 A0 90
        sty     MENDDX                          ; ECD5 84 61
        ldy     #$05                            ; ECD7 A0 05
        sty     MENDDY                          ; ECD9 84 62
        rts                                     ; ECDB 60
...
LEE8B:
        ldy     #$D7                            ; EE8B A0 D7
        lda     $8004                           ; EE8D AD 04 80
        jsr     LEEBA                           ; EE90 20 BA EE
        ldy     #$DA                            ; EE93 A0 DA
        lda     $8005                           ; EE95 AD 05 80
        jsr     LEEBD                           ; EE98 20 BD EE
        ldy     #$BF                            ; EE9B A0 BF
        lda     $8000                           ; EE9D AD 00 80
        jsr     LEEBA                           ; EEA0 20 BA EE
        ldy     #$C2                            ; EEA3 A0 C2
        lda     $8002                           ; EEA5 AD 02 80
        jsr     LEEBD                           ; EEA8 20 BD EE
        ldy     #$C9                            ; EEAB A0 C9
        lda     $8001                           ; EEAD AD 01 80
        jsr     LEEBA                           ; EEB0 20 BA EE
        ldy     #$CC                            ; EEB3 A0 CC
        lda     $8003                           ; EEB5 AD 03 80
...
LEEE8:
        lda     #$00                            ; EEE8 A9 00
        sta     $8008                           ; EEEA 8D 08 80
        sta     $8004                           ; EEED 8D 04 80
        jsr     LF2CF                           ; EEF0 20 CF F2
        lda     #$01                            ; EEF3 A9 01
        sta     $8005                           ; EEF5 8D 05 80
        lda     #$00                            ; EEF8 A9 00
        ldy     #$80                            ; EEFA A0 80
...
LEF58:
        ...
        asl     $0275                           ; EF5B 0E 75 02
        sec                                     ; EF5E 38
        ror     $0275                           ; EF5F 6E 75 02
        lda     #$03                            ; EF62 A9 03
        sta     $02A3                           ; EF64 8D A3 02
        lda     #$8F                            ; EF67 A9 8F
        _XCL2                                   ; EF69 00 06
LEF6B:
        lda     #$91                            ; EF6B A9 91
...
LEF90:
        eor     $8006                           ; EF90 4D 06 80
        sta     $8006                           ; EF93 8D 06 80
LEF96:
...
; ----------------------------------------------------------------------------
LEF9C:
        sta     $8004                           ; EF9C 8D 04 80
        sty     $8005                           ; EF9F 8C 05 80
        beq     LEF96                           ; EFA2 F0 F2
LEFA4:
        sta     $8000                           ; EFA4 8D 00 80
        sty     $8002                           ; EFA7 8C 02 80
        beq     LEF96                           ; EFAA F0 EA
LEFAC:
        sta     $8001                           ; EFAC 8D 01 80
        sty     $8003                           ; EFAF 8C 03 80
...
LEFD2:
        ...
        ldx     #$06                            ; EFD6 A2 06
LEFD8:
        lda     $8000,x                         ; EFD8 BD 00 80
        pha                                     ; EFDB 48
        lda     VARAPL,x                        ; EFDC B5 D0
        sta     $8000,x                         ; EFDE 9D 00 80
        dex                                     ; EFE1 CA
        bpl     LEFD8                           ; EFE2 10 F4
        lda     #$40                            ; EFE4 A9 40
        sta     $8006                           ; EFE6 8D 06 80
        lda     VDTX                            ; EFE9 A5 38
        ldy     VDTY                            ; EFEB A4 39
        sta     $8004                           ; EFED 8D 04 80
        sty     $8005                           ; EFF0 8C 05 80
...
LF25E:
        ...
        sta     $EA                             ; F262 85 EA
        sty     $EB                             ; F264 84 EB
        bit     $8006                           ; F266 2C 06 80
        bpl     LF2A5                           ; F269 10 3A
        lda     $8000                           ; F26B AD 00 80
        bne     LF285                           ; F26E D0 15
        lda     $8002                           ; F270 AD 02 80
        cmp     #$01                            ; F273 C9 01
        bne     LF285                           ; F275 D0 0E
        lda     $8001                           ; F277 AD 01 80
        cmp     #$27                            ; F27A C9 27
        bne     LF285                           ; F27C D0 07
        lda     $8003                           ; F27E AD 03 80
        cmp     #$18                            ; F281 C9 18
        beq     LF24D                           ; F283 F0 C8
LF285:
        ldy     $8002                           ; F285 AC 02 80
LF288:
        jsr     LF2A9                           ; F288 20 A9 F2
        lda     #$20                            ; F28B A9 20
        jsr     LF24F                           ; F28D 20 4F F2
        sec                                     ; F290 38
        lda     $8001                           ; F291 AD 01 80
        sbc     $8000                           ; F294 ED 00 80
        tax                                     ; F297 AA
        beq     LF29D                           ; F298 F0 03
        jsr     LF2B9                           ; F29A 20 B9 F2
LF29D:
        iny                                     ; F29D C8
        cpy     $8003                           ; F29E CC 03 80
...
; ----------------------------------------------------------------------------
        ldy     $8002                           ; F2A6 AC 02 80
LF2A9:
        ldx     $8000                           ; F2A9 AE 00 80
LF2AC:
        inx                                     ; F2AC E8
...
LF2CF:
        lda     #$00                            ; F2CF A9 00
        ldy     #$01                            ; F2D1 A0 01
        sta     $8000                           ; F2D3 8D 00 80
        sty     $8002                           ; F2D6 8C 02 80
        lda     #$27                            ; F2D9 A9 27
        ldy     #$18                            ; F2DB A0 18
        sta     $8001                           ; F2DD 8D 01 80
        sty     $8003                           ; F2E0 8C 03 80
        lda     #$C0                            ; F2E3 A9 C0
        sta     $8006                           ; F2E5 8D 06 80
        rts                                     ; F2E8 60
...
LF2F8:
        ...
        lda     $8002                           ; F2FF AD 02 80
        sta     VDTY                            ; F302 85 39
LF304:
        _XVDTCS                                 ; F304 00 30
        ldy     $8000                           ; F306 AC 00 80
LF309:
...
LF316:
        inc     VDTY                            ; F316 E6 39
        lda     VDTY                            ; F318 A5 39
        cmp     $8003                           ; F31A CD 03 80
        bcc     LF304                           ; F31D 90 E5
        beq     LF304                           ; F31F F0 E3
        lda     #$14                            ; F321 A9 14
        bit     $8006                           ; F323 2C 06 80
        bvc     LF32A                           ; F326 50 02
        lda     #$11                            ; F328 A9 11
LF32A:
        jsr     LF24F                           ; F32A 20 4F F2
        ldx     $8004                           ; F32D AE 04 80
        ldy     $8005                           ; F330 AC 05 80
...
LF577:
        lda     VDTX                            ; F577 A5 38
        ldy     VDTY                            ; F579 A4 39
        sta     $8004                           ; F57B 8D 04 80
        sty     $8005                           ; F57E 8C 05 80
        lda     #$00                            ; F581 A9 00
        bit     FLGVD1                          ; F583 24 3D
        bpl     LF589                           ; F585 10 02
        lda     #$40                            ; F587 A9 40
LF589:
        sta     $8006                           ; F589 8D 06 80
...
; ----------------------------------------------------------------------------
        jmp     LECCC                           ; FFBC 4C CC EC

; ----------------------------------------------------------------------------
        jmp     LE045                           ; FFBF 4C 45 E0

; ----------------------------------------------------------------------------
        jmp     LF2EC                           ; FFC2 4C EC F2

; ----------------------------------------------------------------------------
        jmp     LE4A6                           ; FFC5 4C A6 E4
